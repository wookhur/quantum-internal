...
- installments: 납입 일정 배열. 계약금, 중도금, 잔금 등 분할 납부 정보가 있으면 추출. 각 항목은 아래 형식:
  - label: 항목명 (예: "계약금", "중도금", "잔금", "1차", "2차" 등)
  - amount: 금액 (숫자만)
  - dueDate: 납입 기한 (YYYY-MM-DD 형식, 없으면 null)
  납입 정보가 없으면 빈 배열 []을 반환하세요.
